...
```
Replace NA in total catch with zeros, replace negative aquaculture production with NA. Then,I also divide the aquaculture produciton by 1000 to convert kg to tons.
...
For the spatial-temporal analysis, I will need only the municipalities for which we have at least 10 years of data. We cannot account for temporal correlation wiht less than 10 years of data, or it would be a very poor model with misspecified parameters. 
