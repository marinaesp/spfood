...
I will rand the distance from 1 to max, to have all covariates in a similar scale
...
spfood_data <- aqua_prep |> 
  ...
  left_join(wforce_prep2[,c(1,3,4)],by=c("municip_number", "year")) |> 
  left_join(geo_prep[,c(1,3)],by=c("municip_number"))
```
